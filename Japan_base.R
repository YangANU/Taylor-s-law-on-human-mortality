...
savepdf("Japan_total", width = 12, height = 10, toplines = 0.9)
plot(extract.years(Japan, 1975:2018), series = "total", lwd = 1, main="Japan: total death rates (1975-2018)")
dev.off()

savepdf("Japan_female", width = 12, height = 10, toplines = 0.9)
plot(extract.years(Japan, 1975:2018), series = "female", lwd = 1, main="Japan: female death rates (1975-2018)")
dev.off()

savepdf("Japan_male", width = 12, height = 10, toplines = 0.9)
plot(extract.years(Japan, 1975:2018), series = "male", lwd = 1, main="Japan: male death rates (1975-2018)")
dev.off()
...
for(i in 1:47)
{
  print(paste(state[i+1], " = ", sum(get(state[i+1])$rate$female[1:21,] == 0)))
}
