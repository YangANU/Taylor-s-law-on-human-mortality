...
save(female_long_run_spatial_var, file = "female_long_run_spatial_var.RData")
save(male_long_run_spatial_var, file = "male_long_run_spatial_var.RData")
save(total_long_run_spatial_var, file = "total_long_run_spatial_var.RData")
...
hampel_long_run_female = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
hampel_long_run_female_quadratic = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
hampel_long_run_female_cubic = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
hampel_long_run_male = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
hampel_long_run_male_quadratic = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
hampel_long_run_male_cubic = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
hampel_long_run_total = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
hampel_long_run_total_quadratic = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
hampel_long_run_total_cubic = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_combined[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_combined_complex[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_quadratic_combined[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_quadratic_combined_complex[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_cubic_combined[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female_cubic_combined_complex[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_combined[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_combined_complex[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_quadratic_combined[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_quadratic_combined_complex[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_cubic_combined[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male_cubic_combined_complex[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
hampel_model = rlm(log(diag(female_long_run_spatial_var$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$female), base = 10), psi = psi.hampel_95, maxit = 200)
...
hampel_model = rlm(log(diag(male_long_run_spatial_var$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$male), base = 10), psi = psi.hampel_95, maxit = 200)
...
hampel_model = rlm(log(diag(total_long_run_spatial_var$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$total), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_combined[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_combined_complex[[i]] = rlm(y ~ x, psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_quadratic_combined[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_quadratic_combined_complex[[i]] = rlm(y ~ x + I(x^2), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_cubic_combined[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total_cubic_combined_complex[[i]] = rlm(y ~ x + I(x^2) + I(x^3), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_female[[i]] = rlm(log(diag(female_long_run_spatial_combined_all[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$female), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:20)
{
  ...
  hampel_list_female_refined[[i]] = rlm(log(diag(female_long_run_spatial_combined_all_refined[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$female), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_male[[i]] = rlm(log(diag(male_long_run_spatial_combined_all[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$male), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:20)
{
  ...
  hampel_list_male_refined[[i]] = rlm(log(diag(male_long_run_spatial_combined_all_refined[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$male), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:21)
{
  ...
  hampel_list_total[[i]] = rlm(log(diag(total_long_run_spatial_combined_all[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$total), base = 10), psi = psi.hampel_95, maxit = 200)
...
for(i in 1:20)
{
  ...
  hampel_list_total_refined[[i]] = rlm(log(diag(total_long_run_spatial_combined_all_refined[[i]]$long_run_spatial_variance$BT_FT_fix_C0), base = 10) ~ log(rowMeans(Japan$rate$total), base = 10), psi = psi.hampel_95, maxit = 200)
...
savepdf("fitted_LR_spatial_05", width = 12, height = 10, toplines = 0.8)
# total
plot(OLS_list_total_cubic_combined[[2]]$fitted.values, type = "l", ylab = expression(paste("Fitted ", log[10], "(long-run spatial variance)")), xlab = "Age")
lines(hampel_list_total_cubic_combined[[2]]$fitted.values, col = 1, lty = 2)
lines(bisquare_list_total_cubic_combined[[2]]$fitted.values, col = 1, lty = 3)
# female
lines(hampel_list_female_cubic_combined[[2]]$fitted.values, col =2)
lines(hampel_list_female_cubic_combined[[2]]$fitted.values, col = 2, lty = 2)
lines(bisquare_list_female_cubic_combined[[2]]$fitted.values, col = 2, lty = 3)
# male
lines(bisquare_list_male_cubic_combined[[2]]$fitted.values, col = 4)
lines(hampel_list_male_cubic_combined[[2]]$fitted.values, col = 4, lty = 2)
lines(bisquare_list_male_cubic_combined[[2]]$fitted.values, col = 4, lty = 3)
# legend
legend_order <- matrix(1:12, ncol=2, nrow = 6, byrow = FALSE)
legend("topleft",c("Total OLS","Total Hampel", "Total Bisquare", "Female OLS","Female Hampel","Female Bisquare", "Male OLS", "Male Hampel", "Male Bisquare")[legend_order],
       lty=c(1,2,3,1,2,3,1,2,3)[legend_order],
       col=c(1,1,1,2,2,2,4,4,4)[legend_order],
       ncol=2, cex = 0.8)
dev.off()

savepdf("fitted_LR_spatial_50", width = 12, height = 10, toplines = 0.8)
# total
plot(OLS_list_total_cubic_combined[[11]]$fitted.values, type = "l", ylab = "", xlab = "Age")
lines(hampel_list_total_cubic_combined[[11]]$fitted.values, col = 1, lty = 2)
lines(bisquare_list_total_cubic_combined[[11]]$fitted.values, col = 1, lty = 3)
# female
lines(hampel_list_female_cubic_combined[[11]]$fitted.values, col =2)
lines(hampel_list_female_cubic_combined[[11]]$fitted.values, col = 2, lty = 2)
lines(bisquare_list_female_cubic_combined[[11]]$fitted.values, col = 2, lty = 3)
# male
lines(bisquare_list_male_cubic_combined[[11]]$fitted.values, col = 4)
lines(hampel_list_male_cubic_combined[[11]]$fitted.values, col = 4, lty = 2)
lines(bisquare_list_male_cubic_combined[[11]]$fitted.values, col = 4, lty = 3)
dev.off()

savepdf("fitted_LR_spatial_95", width = 12, height = 10, toplines = 0.8)
# total
plot(OLS_list_total_cubic_combined[[20]]$fitted.values, type = "l", ylab = "", xlab = "Age")
lines(hampel_list_total_cubic_combined[[20]]$fitted.values, col = 1, lty = 2)
lines(bisquare_list_total_cubic_combined[[20]]$fitted.values, col = 1, lty = 3)
# female
lines(hampel_list_female_cubic_combined[[20]]$fitted.values, col =2)
lines(hampel_list_female_cubic_combined[[20]]$fitted.values, col = 2, lty = 2)
lines(bisquare_list_female_cubic_combined[[20]]$fitted.values, col = 2, lty = 3)
# male
lines(bisquare_list_male_cubic_combined[[20]]$fitted.values, col = 4)
lines(hampel_list_male_cubic_combined[[20]]$fitted.values, col = 4, lty = 2)
lines(bisquare_list_male_cubic_combined[[20]]$fitted.values, col = 4, lty = 3)
dev.off()
